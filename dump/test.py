...
class Global:
    ...
    def infer_key(self):
        encrypted_text = self.readfile(input("Please enter the file to analyze: "))
        master_frequency = self.master_freq_dict(
        ...
        if (
            ...
            output_file = input("\nPlease enter a output file: ")
            self.writefile(self.decrypt_key(encrypted_text, best_shift), output_file)
    ...
    def sort_file(self):
        ...
        for file_name in files:
            ...
            best_shift = self.best_caesar_shift(encrypted_text, master_freq_dict)
...
def main():
    ...
    menu.add(global_.encrypt_decrypt_file, 2, "Encrypt/Decrypt File")
    menu.add(global_.letter_frequency, 3, "Analyze letter frequency distribution")
    menu.add(global_.infer_key, 4, "Infer caesar cipher key from file")
    menu.add(global_.sort_file, 5, "Analyze, and sort encrypted files")
    menu.add(global_.option1, 6, "Extra Option One")
    menu.add(global_.option2, 7, "Extra Option Two")
